---
name: abp-cli
description: "ABP Framework v10.x (10.4–10.6) CLI and tooling: abp new, add-package, generate-proxy, ABP Studio, ABP Suite, --modern flag. Use when working with ABP CLI commands, creating projects, adding packages, or generating proxies."
---

# ABP Framework — CLI & Tooling

ABP Framework v10.x (10.4–10.6) CLI commands, ABP Studio, ABP Suite, and development tooling guide.
