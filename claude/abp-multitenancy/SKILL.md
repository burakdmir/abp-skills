...
description: "ABP Framework v10.x (10.4–10.6) multi-tenancy: tenant resolver, ICurrentTenant, IMultiTenant, database isolation, tenant-based data filtering. Use when working with SaaS, multi-tenancy, or tenant management in ABP."
---

# ABP Framework — Multi-Tenancy

ABP Framework v10.x (10.4–10.6) multi-tenancy (SaaS) implementation guide. Tenant resolver, IMultiTenant, ICurrentTenant, database isolation.
